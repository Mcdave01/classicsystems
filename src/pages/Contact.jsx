...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Here you would typically use a service like EmailJS, Formspree, or your own backend API
      ...
      //   body: JSON.stringify({
      //     ...formData,
      //     to: 'support@classicsystemsinfotech.ng' 
      //   }),
      // });
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="mb-6 text-gray-600">We'd love to hear from you. Please fill out the form and we'll get back to you as soon as possible.</p>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">No 39 Mayfair, Ile-Ife, Osun State, Nigeria</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">support@classicsystemsinfotech.ng</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+234 (0) 805 362 8635</p>
                    </div>
                  </div>
            ...
            <div className="mt-10 pt-6 border-t border-gray-200">
              ...
              <div className="h-96 rounded-md overflow-hidden">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3956.9324858895405!2d4.518402776172936!3d7.4817173129149585!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1039ed8d1294e1c5%3A0xd0b07514cba28921!2sMayfair%2C%20Ile-Ife%2C%20Osun%20State%2C%20Nigeria!5e0!3m2!1sen!2sus!4v1711335159028!5m2!1sen!2sus" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen="" 
                  ...
                  title="Classic Systems Infotech location"
                ></iframe>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-600">
              Visit <a href="https://classicsystemsinfotech.ng" className="text-blue-600 hover:underline">classicsystemsinfotech.ng</a> for more information
            </p>
          </div>
        </div>
      </section>
