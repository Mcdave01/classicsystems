...
import { faLaptop, faMobileAlt, faPrint, faProjectDiagram, faChalkboardTeacher } from '@fortawesome/free-solid-svg-icons'; // Import all icons
      ...
      <div>
        ...
        <div className="flex flex-col sm:flex-col h-[500px] lg:flex-row items-center justify-center gap-12 p-4" data-aos="zoom-in">
          {services.map((service, index) => (
            <Cards key={index} className="card flex flex-col items-center 
